        ...
        <div className='px-8 pt-5 h-[550px] md:h-[650px]  lg:h-[450px] backdrop-blur-lg bg-black/75  pb-10' id='container-scroll'>
            <div className='space-y-3'>
                <div className='flex justify-between items-center'>
                    ...
                    <p className='text-gray-600 fonr-semibold '>Bangladesh</p>
                </div>
                <div className='flex justify-between items-center'>
                    <p className='text-white fonr-bold'>City:</p>
                    <p className='text-gray-600 fonr-semibold '>Naogaon</p>
                </div>
                <div className='flex justify-between items-center'>
                    <p className='text-white fonr-bold'>Age:</p>
                    <p className='text-gray-600 fonr-semibold '>26</p>
                </div>
            </div>
            ...
            <div className='space-y-3 '>
                <div>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-700">
                        <div className="bg-yellow-600 h-1.5 rounded-full" style={{ width: '95%' }}></div>
                    </div>
                </div>
                <div>
                    <div className='flex justify-between items-center'>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-700">
                        <div className="bg-yellow-600 h-1.5 rounded-full" style={{ width: '90%' }}></div>
                    </div>
                </div>
                <div>
                    <div className='flex justify-between items-center'>
